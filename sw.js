...
const PRECACHE_ASSETS = [
  '/App-Ordenes-De-Trabajo/index.html',
  '/App-Ordenes-De-Trabajo/manifest.json',
  '/App-Ordenes-De-Trabajo/icon-192.png',
  '/App-Ordenes-De-Trabajo/icon-512.png',
...
async function networkFirst(request) {
  ...
  try {
    ...
    if (request.mode === 'navigate') {
      return cache.match('/App-Ordenes-De-Trabajo/index.html');
    }
